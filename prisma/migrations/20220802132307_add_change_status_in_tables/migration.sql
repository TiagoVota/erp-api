/*
  ...
  - Added the required column `updatedAt` to the `enterpises` table without a default value. This is not possible if the table is not empty.
...
*/
-- AlterTable
ALTER TABLE "enterpises" ADD COLUMN     "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
